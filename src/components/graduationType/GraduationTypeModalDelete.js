...
class GraduationTypeModalDelete extends Component {
  constructor(props) {
    super(props);
    this.state = {
      //errors
      ...
      switch (nextProps.errors.code) {
        case "assignments-02":
          ...
          if (nextProps.errors.devMessage.name === "SequelizeForeignKeyConstraintError") {
            newErrors.graduationType = "A atribuição está em uso dentro do sistema.";
...
GraduationTypeModalDelete.proptypes = {
