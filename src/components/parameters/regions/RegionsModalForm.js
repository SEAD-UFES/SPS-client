...
import { validateRegionsForm } from "./validateRegionsForm";
import { clearErrors } from "../../../actions/errorActions";

class RegionsModalForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      //component options
  ...
  onSubmit() {
    ...
    //Form validation:
    const valRegion = validateRegionsForm(regionData);
