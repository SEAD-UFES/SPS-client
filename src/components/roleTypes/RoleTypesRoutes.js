...
import RoleTypePermAssigDelete from "components/roleTypes/RoleTypePermAssigDelete";
    ...
    return (
      <Switch>
        ...
        <PrivateRoute
          ...
          }/:roletype_id/delete-permassig/:permissionassignment_id`}
          component={RoleTypePermAssigDelete}
        />
      </Switch>
    );
  }
