...
import PetitionReadContainer from './PetitionReadContainer'
import PetitionDeleteContainer from './PetitionDeleteContainer'

import PrivateRoute from '../../components/common/PrivateRoute'
import NotFound from '../../components/common/NotFound'

export default class PetitionRoutes extends Component {
  render() {
    return (
      <Switch>
        <PrivateRoute exact path={`${this.props.match.path}/create`} component={PetitionCreateContainer} />
        <PrivateRoute exact path={`${this.props.match.path}/read/:id`} component={PetitionReadContainer} />
