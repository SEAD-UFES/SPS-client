...
export default function(state = initialState, action) {
  let newState
  switch (action.type) {
    case LOADING_INSCRIPTIONEVENT:
      return { ...state, loading: true }
    case CREATE_INSCRIPTIONEVENT:
    case READ_INSCRIPTIONEVENT:
    case UPDATE_INSCRIPTIONEVENT:
    ...
    case READ_LIST_INSCRIPTIONEVENT:
